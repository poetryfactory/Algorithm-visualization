...
detailpage::detailpage(std::string dsname, QWidget *parent)
    : QMainWindow(parent) {
  ...
  h1->setStyleSheet(
      "border-width: 0px; border-style:outset; background: rgba(255,0,0,0);");
  ...
  if (son->myname == "array") {
    btn1->setText("添加数组");
  } else if (son->myname == "list") {
    btn1->setText("");
  } else if (son->myname == "tree") {
    btn1->setText("");
  } else if (son->myname == "graph") {
    btn1->setText("");
  }
  btn1->setStyleSheet(
      "QPushButton{background-color: rgba(58,143,192,20); border-radius: 15px; "
      "font: bold 28px; font-family: Calibri;}"
  ...
  connect(btn2, &QPushButton::clicked, this, [=]() {
    //h3->setText("您选择的模式为：模式二");
    if (son->myname == "array")
      h3->setText("您选择的模式为：添加栈");
      emit son->bt2();
    // else if(son->myname=="????")
    // emit son->bt2();
    //如果要按下按钮直接执行操作 可以把bt*连到自己的函数上 后面同理
  });

  QPushButton *btn3 = new QPushButton();
  if (son->myname == "array") {
    btn3->setText("数组添加随机元素");
  } else if (son->myname == "list") {
    btn3->setText("");
  } else if (son->myname == "tree") {
    btn3->setText("");
  ...
  btn3->setStyleSheet(
      "QPushButton{background-color: rgba(58,143,192,20); border-radius: 15px; "
      "font: bold 18px; font-family: Calibri;}"
      "QPushButton:pressed{background-color: rgba(84,255,159,20);}");
  btn3->move(1090, 260);
  btn3->setParent(this);
  btn3->resize(160, 50);
  connect(btn3, &QPushButton::clicked, this, [=]() {
    //h3->setText("您选择的模式为：模式三");
    if (son->myname == "array")
      h3->setText("您选择的模式为：数组添加随机元素");
      emit son->bt3();
  });
  ...
  connect(btn4, &QPushButton::clicked, this, [=]() {
    //h3->setText("您选择的模式为：模式四");
    if (son->myname == "array")
      h3->setText("您选择的模式为：数组排序");
      emit son->bt4();
  });
  ...
  btn5->setStyleSheet(
      "QPushButton{background-color: rgba(58,143,192,20); border-radius: 15px; "
      "font: bold 20px; font-family: Calibri;}"
      "QPushButton:pressed{background-color: rgba(84,255,159,20);}");
  btn5->move(910, 420);
  btn5->setParent(this);
  btn5->resize(160, 50);
  connect(btn5, &QPushButton::clicked, this, [=]() {
    //h3->setText("您选择的模式为：模式五");
    if (son->myname == "array")
      h3->setText("您选择的模式为：数组元素压栈");
      emit son->bt5();
  });
  ...
  connect(btn6, &QPushButton::clicked, this, [=]() {
    //h3->setText("您选择的模式为：模式六");
    if (son->myname == "array")
      h3->setText("您选择的模式为：加速");
      emit son->bt6();
  });
  ...
  moreInfo->setStyleSheet(
      "QPushButton{background-color: rgba(241,246,250,1); border-radius: 15px; "
      "font: bold 32px; font-family: Calibri;}"
  ...
  btn7->setStyleSheet(
      "QPushButton{background-color: rgba(241,246,250,1); border-radius: 15px; "
      "font: bold 24px; font-family: Calibri;}"
      "QPushButton:hover{background-color: rgba(58,143,192,20);}");
...
void detailpage::paintEvent(QPaintEvent *) {
...
void detailpage::mousePressEvent(QMouseEvent *event) {

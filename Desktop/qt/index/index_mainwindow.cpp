    ...
    , ui(new Ui::index_mainWindow)
{
    ...
    scrollArea->setStyleSheet("background: rgba(163,198,236,1); border-radius: 0px");

    jumptoBtn = new mybutton(":/img/img/rightArrow.png");
    jumptoBtn->setParent(scrollWidget);
    jumptoBtn->move(150,50);
    jumptoBtn->setFixedSize(400,400);
    jumptoBtn->setStyleSheet("border-style: solid; border-width: 2px; border-radius: 20px; border-color: rgb(169,169,169)");
    ...
    h4->setStyleSheet("border: 2px groove gray; border-radius: 10px; padding-bottom:5px");

    jumptoBtn3 = new mybutton(":/img/img/rightArrow.png");
    jumptoBtn3->setParent(scrollWidget);
    jumptoBtn3->move(150,550);
    jumptoBtn3->setFixedSize(400,400);
    jumptoBtn3->setStyleSheet("border-style: solid; border-width: 2px; border-radius: 20px; border-color: rgb(169,169,169)");
    ...
    h5->setStyleSheet("border: 2px groove gray; border-radius: 10px; padding-bottom:5px");

    jumptoBtn4 = new mybutton(":/img/img/rightArrow.png");
    jumptoBtn4->setParent(scrollWidget);
    jumptoBtn4->move(750,550);
    jumptoBtn4->setFixedSize(400,400);
    jumptoBtn4->setStyleSheet("border-style: solid; border-width: 2px; border-radius: 20px; border-color: rgb(169,169,169)");
    ...
    h6->setStyleSheet("border: 2px groove gray; border-radius: 10px; padding-bottom:5px");
}
...
index_mainWindow::~index_mainWindow()
{
    delete ui;
}
